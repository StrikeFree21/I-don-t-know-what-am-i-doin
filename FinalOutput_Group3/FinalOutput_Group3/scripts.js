...
document.getElementById('search-bar').addEventListener('input', function() {
    ...
    trainers.forEach(trainer => {
        let trainerName = trainer.querySelector('h4').textContent.toLowerCase();
        let trainerDescription = trainer.querySelector('p').textContent.toLowerCase();
        
        if (trainerName.includes(searchQuery) || trainerDescription.includes(searchQuery)) {
